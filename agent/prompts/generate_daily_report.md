...
- Do not include a `数据概览` section. Statistics are shown by generated charts instead.
...
Do not describe chart recommendations in the report body. The pipeline appends generated charts separately.
